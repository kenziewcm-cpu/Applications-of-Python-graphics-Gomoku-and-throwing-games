...
def main3():
        buttons=[]
        win2=GraphWin("游戏选择",800,500)
        win2.setCoords(0,0,100,100)
        background = Image( Point(50,50),"游戏山庄.gif")
        background.draw(win2)
        game1=Button(win2,Point(82,55),20,10,"四子棋")
        buttons.append(game1)
        game1.activate()
        game2=Button(win2,Point(82,30),20,10,"模拟教室")
        buttons.append(game2)
        game2.activate()
        while True:
            pt1=win2.getMouse()
            if game1.clicked(pt1):
                main()
                
                
            if game2.clicked(pt1):
                main2()
